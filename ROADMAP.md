...
`#########·` 88% · 14 of 16 done · due 2026-09-21
...
- [x] `0004` `biotic curve` — plot a run <sup>feature · p1</sup>
- [x] `0005` The freezer: `biotic freeze` and `biotic revive` <sup>feature · p0</sup>
- [x] `0006` Replicate flasks: many dishes from one install <sup>feature · p1</sup>
...
- [x] `0012` Predation: `("lyse", d)` <sup>feature · p0</sup>
